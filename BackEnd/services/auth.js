    ...
    try {
        ...
        if (password) {
            ...
            if (platform == PLATFORM.USERAPP) {
                ...
                if (!LOGIN_ACCESS[user.userType].includes(PLATFORM.OPERATOR)) {
                    return { flag: true, data: 'you are unable to access this platform' }
                }
                console.log("work operator") 
...
module.exports = {loginUser,sendResetPasswordOtpNotification,resetPassword,socialLogin }