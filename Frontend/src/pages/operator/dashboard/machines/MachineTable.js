...
import {machinesApi} from '../../../../mocks/operator/machines';
import Navbar from "../../../../components/layout/Navbar"
import {OperatorAuth} from "../../../../components/Authenticated/OperatorAuth"
...
// 6. query change function
 ...
 // 10. change view(grid or table) function
  ...
  return (
    ...
    <Navbar user={user} platformToken={PLATFORM_TOKEN.OPERATOR}/>
      <Box
        display="flex"
        alignItems="center"
